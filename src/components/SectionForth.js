...
import pricesction from "./poster/priceaction.png"
    ...
    return (
      <div className=" relative">
       ...
       <div className="flex flex-col items-center">
            <h1 className="font-sans font-bold text-4xl  text-themegreen  md:text-6xl">Courses We Offer</h1>
            <h3 className="font-sans font-normal text-center text-textwhite text-xl ">Transform knowledge into profitable trading decisions.</h3>
       </div>

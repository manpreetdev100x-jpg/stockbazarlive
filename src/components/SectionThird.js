...
import logo from "./images/stockbazar.jpg"
        ...
        <div className="w-full h-auto  py-8">
            <div className="flex flex-col md:flex-row md:items-center mx-10 md:mx-20">
                ...
                <div className="w-full mt-5 md:mt-0 abovez md:w-1/2">
                    <h1 className=" font-hedaingfont font-bold text-xl text-themegreen md:text-5xl">Why Choose Us ?</h1>
                    <h3 className="font-hedaingfont font-bold text-2xl text-themegreen md:text-3xl">We Simplify Trading</h3>

    ...
    return (
        <div className="  mx-10 h-auto pb-16 bg-themeblack md:mx-20 overflow-hidden ">
            ...
            <div className=" flex flex-col items-center">
                <h1 className="font-sans text-4xl text-themegreen md:text-6xl font-bold">Segments</h1>
                <h4 className="md:text-2xl text-xl text-themegreen font-normal font-thin pt-0">Journey to Become Master</h4>
            </div>
